...
export async function generateMetadata() {
  ...
  return {
    ...
    openGraph: {
      title,
      description,
      url: `${SITE_CONFIG.url}/cloud-based-inventory-management`,
      siteName: SITE_CONFIG.name,
      images: [{ url: `${SITE_CONFIG.url}/assets/articles/article-cloud-security-1.webp`, width: 1200, height: 630, alt: title }],
      type: 'article',
    ...
    twitter: {
      ...
      title,
      description,
      images: [`${SITE_CONFIG.url}/assets/articles/article-cloud-security-1.webp`],
    },
    alternates: {
      canonical: `${SITE_CONFIG.url}/cloud-based-inventory-management`,
    },
  };
}
