...
export async function generateMetadata() {
  ...
  return {
    ...
    openGraph: {
      ...
      images: [{ url: `${SITE_CONFIG.url}/assets/articles/article-odoo-zatca-1.webp`, width: 1200, height: 630, alt: title }],
      type: 'article',
    ...
    twitter: {
      ...
      title,
      description,
      images: [`${SITE_CONFIG.url}/assets/articles/article-odoo-zatca-1.webp`],
    },
    alternates: {
