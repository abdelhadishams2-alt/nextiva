      ...
      <main>
        ...
        <section id="section-1" className="article-section article-hero">
          <div className="article-hero__bg">
            <Image src="/assets/articles/odoo-saudi-arabia-1.webp" alt={t('heroImageAlt')} fill priority fetchPriority="high" quality={80} sizes="100vw" placeholder="blur" blurDataURL="data:image/webp;base64,UklGRlAAAABXRUJQVlA4IEQAAACwAQCdASoMAAYAA4BaJZwAAfJj/sUAAOA19N2xSey04rJWouH+G7/d0JjGJ3zml4mwYwTRe6kZW2j3Z8x3A0nQYEAAAA==" style={{ objectFit: 'cover' }} />
          </div>
            ...
            <div className="article-main">
              ...
              <section id="section-3" className="fade-up article-section">
                ...
                <figure className="article-image article-image--contextual">
                  <Image src="/assets/articles/odoo-saudi-arabia-2.webp" alt={t('s3ImageAlt')} width={1200} height={630} quality={80} sizes="(max-width: 768px) 100vw, 800px" loading="eager" fetchPriority="low" placeholder="blur" blurDataURL={BLUR_DATA_URL} />
              ...
              <section id="section-4" className="fade-up article-section">
                ...
                <p>{t('s4Intro')}</p>
                <figure className="article-image article-image--contextual">
                  <Image src="/assets/articles/odoo-saudi-arabia-3.webp" alt={t('s4ImageAlt')} width={1200} height={630} quality={80} sizes="(max-width: 768px) 100vw, 800px" loading="eager" fetchPriority="low" placeholder="blur" blurDataURL={BLUR_DATA_URL} />
