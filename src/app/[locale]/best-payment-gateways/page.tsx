            ...
            <div className="article-main">
              ...
              <section id="section-2" className="fade-up article-section">
                ...
                <figure className="article-image article-image--contextual">
                  <Image src="/assets/articles/payment-gateways-local-methods.webp" alt="Contactless payment card and smartphone with Saudi fintech aesthetic" width={1200} height={630} quality={80} sizes="(max-width: 768px) 100vw, 800px" loading="eager" fetchPriority="low" placeholder="blur" blurDataURL={BLUR_DATA_URL} />
              ...
              <section id="section-4" className="fade-up article-section">
                ...
                <figure className="article-image article-image--contextual">
                  <Image src="/assets/articles/payment-gateways-tap.webp" alt="Clean developer workspace with smartphone showing generic payment dashboard" width={1200} height={630} quality={80} sizes="(max-width: 768px) 100vw, 800px" loading="eager" fetchPriority="low" placeholder="blur" blurDataURL={BLUR_DATA_URL} />
              ...
              <section id="section-6" className="fade-up article-section">
                ...
                <figure className="article-image article-image--contextual">
                  <Image src="/assets/articles/payment-gateways-hyperpay.webp" alt="Enterprise data center corridor with glowing server racks" width={1200} height={630} quality={80} sizes="(max-width: 768px) 100vw, 800px" loading="eager" fetchPriority="low" placeholder="blur" blurDataURL={BLUR_DATA_URL} />
              ...
              <section id="section-7" className="fade-up article-section">
                ...
                <figure className="article-image article-image--contextual">
                  <Image src="/assets/articles/payment-gateways-checkout.webp" alt="Global connectivity visualization with glowing cross-continent payment routes" width={1200} height={630} quality={80} sizes="(max-width: 768px) 100vw, 800px" loading="eager" fetchPriority="low" placeholder="blur" blurDataURL={BLUR_DATA_URL} />
