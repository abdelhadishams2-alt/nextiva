            ...
            {paged.map((article) => (
              ...
              >
                <div className="blogs-card__image">
                  <Image src={article.image} alt={article.title} width={600} height={400} loading="eager" fetchPriority="low" quality={75} sizes="(max-width: 768px) 100vw, (max-width: 1024px) 50vw, 33vw" placeholder="blur" blurDataURL={BLUR_DATA_URL} />
                </div>
